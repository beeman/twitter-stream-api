...
var Twitter = module.exports = function (keys, param1, param2)  { 
    ...
    this.connection.on('connection closed', this.emits('connection closed'));
    ...
    this.connection.on('reconnect start', this.emits('reconnect start'));
    this.connection.on('reconnect aborted', this.emits('reconnect aborted'));
    this.connection.on('request close', this.emits('request close'));
    this.connection.on('stream end', this.emits('stream end'));
